...
<body>
	...
	<div class="containerG">
		...
		<?php endif; ?>
		<div class="btnElec">
			<button class="btnDesc"><a href="<?= base_url('user/listEmplT') ?>"><img src="<?= base_url('./assets/img/tableIcon.svg') ?>"></a></button>
			<button class="btnAct"><img src="<?= base_url('./assets/img/cardIcon.svg') ?>"></button>
		</div>
		<div class="btnInac">
			<a href="<?= base_url('user/empInac') ?>"><button class="btnI">Empleados Inactivos</button></a>
		</div>
		<div class="space-search">
			<form class="formS" action="<?= base_url('user/searchEmple') ?>" method="post"><input type="text" name="iden" placeholder="Buscar por identificación"><button><i class="bx bx-search nav__icon"></i></button></form>
		</div>
		<?php if ($data){ ?>
