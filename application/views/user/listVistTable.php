...
<body>
	...
	<div class="Container-modal">
        <form class="formModal" action="<?= base_url('user/importV') ?>" method="POST" enctype="multipart/form-data">
	...
	<div class="containerT">
		...
		<div class="btnD btnIn">
				<a href="<?= base_url('user/listVistIT')?>"><button>Visitantes inactivos</button></a>
		</div>
		<div class="btnElec">
			<button  class="btnAct"><img src="<?= base_url('./assets/img/tableIconAc.svg') ?>"></button>
			<button class="btnDesc"><a href="<?= base_url('user/listVist') ?>"><img src="<?= base_url('./assets/img/cardIconAc.svg') ?>"></a></button>
		</div>
			...
			<table class="miyazaki" id="datat">
				...
				<?php }else{?>
					<tr>
						<td colspan="8">Aún no hay visitantes registrados  o activados en el sistema</td>
					</tr>
				<?php }?>
				</tbody>
			</table>
