...
<body>
	...
	<div class="containerT">
		...
		<div class="btnD btnIn">
				<a href="<?= base_url('user/listEmplT')?>"><button>Empleados activos</button></a>
		</div>
		<div class="btnElec">
			<button  class="btnAct"><img src="<?= base_url('./assets/img/tableIconAc.svg') ?>"></button>
			<button class="btnDesc"><a href="<?= base_url('user/empInac') ?>"><img src="<?= base_url('./assets/img/cardIconAc.svg') ?>"></a></button>
		</div>
			...
			<table class="miyazaki" id="datat">
				...
				<?php }else{?>
					<tr>
						<td colspan="8">No hay empleados inactivos en el sistema</td>
					</tr>
				<?php }?>
				</tbody>
			</table>
