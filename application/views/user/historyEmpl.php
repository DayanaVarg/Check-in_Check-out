...
<body>
	...
	<div class="containerG">
		...
		<?php endif; ?>
		<div class="btnElec">
			<button class="btnDesc"><a href="<?= base_url('user/historyEmplT') ?>"><img src="<?= base_url('./assets/img/tableIcon.svg') ?>"></a></button>
			<button class="btnAct"><img src="<?= base_url('./assets/img/cardIcon.svg') ?>"></button>
		</div>
		<div class="space-search">
			<form class="formS" action="<?= base_url('user/searchEmpl') ?>" method="post"><input type="text" name="iden" placeholder="Buscar por identificación"><button><i class="bx bx-search nav__icon"></i></button></form>
		</div>
		<?php if ($data){ ?>
