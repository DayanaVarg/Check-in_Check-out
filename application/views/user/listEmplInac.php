...
<body>
	...
	<div class="containerG">
		...
		<?php endif; ?>
		<div class="btnElec">
			<button class="btnDesc"><a href="<?= base_url('user/listEmplIT') ?>"><img src="<?= base_url('./assets/img/tableIcon.svg') ?>"></a></button>
			<button class="btnAct"><img src="<?= base_url('./assets/img/cardIcon.svg') ?>"></button>
		</div>
		<div class="btnInac">
			<a href="<?= base_url('user/listEmp') ?>"><button class="btnI">Empleados Activos</button></a>
		</div>
		<div class="space-search">
			<form class="formS" action="<?= base_url('user/searchEmpleI') ?>" method="post"><input type="text" name="iden" placeholder="Buscar por identificación"><button><i class="bx bx-search nav__icon"></i></button></form>
		</div>
		<?php if ($data){ ?>
			...
			<div class="card">
				<div class="space1">
					...
					<div class="fec">
						...
						<div class="column2a">
						<form action="<?= base_url('user/actEm')?>" method="post">
							<input type="hidden" name="iden" value="<?= $item->identification?>">
							<input  type="hidden" name="state" value="1">
							<button class=" btns btnact"type="submit">Activar</button>
						</form>
						</div>
					</div>
					<div class="columns">
