...
<body>
	...
	<div class="Container-modal">
        <form class="formModal" action="<?= base_url('user/importHV') ?>" method="POST" enctype="multipart/form-data">
            <div class="closeB">+</div>
            <p class="title">Seleccionar archivo</p>

            <div class="flex">
				<label>
					<input class="input" type="file" name="file" required accept="csv/*">
	...
	<div class="containerT">
		...
		<button  class="btnAct"><img src="<?= base_url('./assets/img/tableIconAc.svg') ?>"></button>
			<button class="btnDesc"><a href="<?= base_url('user/historyVist') ?>"><img src="<?= base_url('./assets/img/cardIconAc.svg') ?>"></a></button>
		</div>
		
		
		<table class="miyazaki" id="datat">
				<h1 class="titulo">Historial Visitantes</h1>
				<thead >
					<tr>
