...
if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == '127.0.0.1') {
    // Configura la base_url para el entorno local
    $config['base_url'] = 'http://localhost/Check-in_check-out/';
} else {
    // Configura la base_url para el servidor remoto
    $config['base_url'] = 'http://www.CheckIn-CheckOut.com/';
}
